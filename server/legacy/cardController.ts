...
export class CardController {
   ...
   * Using existing working methods mapped to new card types
   */
  private cardCalculators = {
    // Cognitive Snapshot Cards
    'archetype-classifier': this.calculateDegenScore.bind(this),
    'trading-rhythm': this.calculateTradingFrequency.bind(this),
    'risk-appetite-meter': this.calculateRiskAppetite.bind(this),

    // Cognitive Patterns Cards
    'position-sizing-psychology': this.calculatePositionSizing.bind(this),
    'time-of-day-patterns': this.calculateTradingFrequency.bind(this),
    'token-rotation-intelligence': this.calculateTokenLoyalty.bind(this),
    'gas-fee-personality': this.calculateRiskAppetite.bind(this),
    'market-timing-ability': this.calculatePortfolioPerformance.bind(this),

    // Insights Cards
    'conviction-collapse-detector': this.calculateConvictionCollapse.bind(this),
    'fomo-fear-cycle': this.calculateFomoBehavior.bind(this),
    'post-rug-behavior': this.calculateRiskAppetite.bind(this),
    'loss-aversion': this.calculateTokenLoyalty.bind(this),
    'profit-taking-discipline': this.calculatePortfolioPerformance.bind(this),

    // Psychoanalytics Cards
    'narrative-loyalty': this.calculateTokenLoyalty.bind(this),
    'stress-response-patterns': this.calculateRiskAppetite.bind(this),
    'social-trading-influence': this.calculateWhaleFollowing.bind(this),
    'false-conviction': this.calculateConvictionCollapse.bind(this),
    'llm-insight-generator': this.calculateMetaFreshness.bind(this)
  };

  /**
   * ORIGINAL CARD CALCULATIONS
